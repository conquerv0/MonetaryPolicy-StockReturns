...
data_Main = data_Main.rename(columns = {'CES3000000008': 'Prod', 'WTISPLC': 'WTI', 
...
granger = grangers_causation_matrix(data_Main, variables = ['Prod', 'WTI', 'Bread', 'Alcohol', 'Home', 'Apparel'])
...
model_irf.plot(response = 'Alcohol', 
