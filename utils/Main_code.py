...
rank_test= select_coint_rank(data_Main, 1 ,2, method = "trace")
Model_1 = VECM(data_Main, deterministic="li", k_ar_diff = 2,  coint_rank = 1)
Proc = Model_1.fit()
Pr_f = Proc.irf(5)
Pr_Test = Pr_f.irfs
for i in range(6):
...
Pr_f.plot(response = 'L&H', impulse = 'WTI',
